...
public abstract class Mob : MonoBehaviour
{
	...
	public float moveForce = 365f;			// Amount of force added to move the mob left and right.
	public float maxSpeed = 5f;				// The fastest the mob can travel in the x axis.
	public AudioClip[] jumpClips;			// Array of clips for when the mob jumps.
	public float jumpForce = 1000f;			// Amount of force added when the mob jumps.
	public AudioClip[] taunts;				// Array of clips for when the mob taunts.
