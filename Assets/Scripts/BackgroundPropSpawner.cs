...
{
    [Tooltip("The prop to be instantiated.")]
    public Rigidbody2D backgroundProp;
    [Tooltip("The x coordinate of position if it's instantiated on the left.")]
    public float leftSpawnPosX;
    [Tooltip("The x coordinate of position if it's instantiated on the right.")]
    public float rightSpawnPosX;
    [Tooltip("The lowest possible y coordinate of position.")]
    public float minSpawnPosY;
    [Tooltip("The highest possible y coordinate of position.")]
    public float maxSpawnPosY;
    [Tooltip("The shortest possible time between spawns.")]
    public float minTimeBetweenSpawns;
    [Tooltip("The longest possible time between spawns.")]
    public float maxTimeBetweenSpawns;
    [Tooltip("The lowest possible speed of the prop.")]
    public float minSpeed;
    [Tooltip("The highest possible speeed of the prop.")]
