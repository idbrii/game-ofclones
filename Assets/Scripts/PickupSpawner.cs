...
{
    [Tooltip("Array of pickup prefabs with the bomb pickup first and health second.")]
    public GameObject[] pickups;
    [Tooltip("Delay on delivery.")]
    public float pickupDeliveryTime = 5f;
    [Tooltip("Smallest value of x in world coordinates the delivery can happen at.")]
    public float dropRangeLeft;
    [Tooltip("Largest value of x in world coordinates the delivery can happen at.")]
    public float dropRangeRight;
    [Tooltip("The health of the player, above which only bomb crates will be delivered.")]
    public float highHealthThreshold = 75f;
    [Tooltip("The health of the player, below which only health crates will be delivered.")]
